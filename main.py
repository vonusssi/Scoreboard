...
class MyApp(App):
    ...
    def create_profile(self, name):
        ...
        if not self.store.exists(name):
            self.store.put(name, Ever=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Pagan=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Wonders=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Clever=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Clever4=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Kniffel=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Targi=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Dice=[[0,0],["00.00.0000","00.00.0000"],[0,0]], Harmonies=[[0,0],["00.00.0000","00.00.0000"],[0,0]])
        data = self.store.get(name)
        self.scores= {"Ever": list(data["Ever"]),
            "Pagan": list(data["Pagan"]),
            "Wonders": list(data["Wonders"]),
